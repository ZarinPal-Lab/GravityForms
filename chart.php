    ...
    public static function stats_page()
    {
        ...
        <div class="wrap">
            <ul class="subsubsub">
                ...
                <br/><br/>
                <form method="post"
                      action="?page=gf_zaringate&view=stats&id=<?php echo rgget("id") ?>&tab=selection"><?php wp_nonce_field("search", "gf_zarinpal_chart") ?>
            ...
            <div>
                ...
                <div class="zaringate_summary_container">
                    ...
                    <div class="zaringate_summary_item">
                        ...
                        <div
                            class="zaringate_summary_value"><?php echo GF_tr_num($chart_info_site["mid"], 'fa') ?></div>
                    </div>
                    <div class="zaringate_summary_item">
                        <div class="zaringate_summary_title"><?php echo $sales_label ?></div>
                        <div class="zaringate_summary_value"><?php echo GF_tr_num($total_sales, 'fa') ?></div>
