...
class GFPersian_Chart_ZarinPal {

	// ------------------------GravityForms.IR-------------------------
	public static function stats_page() {

		if ( ! empty( $_POST ) ) {
			check_admin_referer( "search", "gf_zarinpal_chart" );
		}
        ...
        <style type="text/css">
            ...
            .zarinpal_summary_value {
                font-size: 20px;
                margin: 5px 0;
            }

            .zarinpal_summary_title {
                height: 40px;
            }
        ...
        <div class="wrap">
            <ul class="subsubsub">
                <li><a class="<?php echo ( ! rgget( "tab" ) || rgget( "tab" ) == "today" ) ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>"><?php _e( "امروز", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "yesterday" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=yesterday"><?php _e( "دیروز", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last7days" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last7days"><?php _e( "هفت روز گذشته", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thisweek" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thisweek"><?php _e( "هفته جاری", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last30days" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last30days"><?php _e( "30 روز گذشته", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thismonth" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thismonth"><?php _e( "ماه جاری", "gravityformszarinpal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "lastmonth" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=lastmonth"><?php _e( "ماه قبل", "gravityformszarinpal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last2month" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last2month"><?php _e( "2 ماه اخیر", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last3month" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last3month"><?php _e( "3 ماه اخیر", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last6month" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last6month"><?php _e( "6 ماه اخیر", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last9month" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last9month"><?php _e( "9 ماه اخیر", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last12month" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last12month"><?php _e( "یک سال اخیر", "gravityformszarinpal" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "spring" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=spring"><?php _e( "بهار", "gravityformszarinpal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "summer" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=summer"><?php _e( "تابستان", "gravityformszarinpal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "fall" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=fall"><?php _e( "پاییز", "gravityformszarinpal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "winter" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=winter"><?php _e( "زمستان", "gravityformszarinpal" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thisyear" ? "current" : "" ?>"
                       href="?page=gf_zarinpal&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thisyear"><?php _e( "امسال", "gravityformszarinpal" ); ?></a>
                </li>
                <br/><br/>
                <form method="post"
                      action="?page=gf_zarinpal&view=stats&id=<?php echo rgget( "id" ) ?>&tab=selection"><?php wp_nonce_field( "search", "gf_zarinpal_chart" ) ?>
                    ...
                    <input type="submit" class="button-primary button" name="submit"
                           value="<?php _e( 'انتخاب', 'gravityformszarinpal' ) ?>"><br>
                </form>
            </ul>
            ...
            <div>
				<?php if ( empty( $chart_info["series"] ) ) { ?>
                    <div
                            class="zarinpal_message_container"><?php _e( "موردی یافت نشد . ", "gravityformszarinpal" ) ?></div>
				<?php } else { ?>
				...
				$transaction_totals = GFPersian_DB_ZarinPal::get_transaction_totals( $form_id );
                ...
                <div class="zarinpal_summary_container">
                    <div class="zarinpal_summary_item">
                        <div
                                class="zarinpal_summary_title"><?php _e( 'جمع پرداخت های  زرین پال این فرم', 'gravityformszarinpal' ) ?></div>
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
            ...
            <hr>
            <div class="clear"></div>
            <h2><?php _e( " درآمد از همه روشها برای فرمِ ", "gravityformszarinpal" ) ?><?php echo '"' . $form["title"] . '"'; ?></h2>
            <div>
				...
				$sales_label = __( "تعداد کل پرداخت های  همه روشهای این فرم", "gravityformszarinpal" );

				$transaction_totals = GFPersian_DB_ZarinPal::get_transaction_totals_gateways( $form_id );
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                ...
                <div class="zarinpal_summary_container">
                    ...
                    <div class="zarinpal_summary_item">
                        <div
                                class="zarinpal_summary_title"><?php _e( "جمع پرداخت های  همه روشهای این فرم", "gravityformszarinpal" ) ?></div>
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zarinpal_summary_item">
                        ...
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_gateways["revenue"], 'fa' ) ?></div>
                    </div>

                    <div class="zarinpal_summary_item">
                        <div class="zarinpal_summary_title"><?php echo $chart_info_gateways["mid_label"] ?></div>
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_gateways["mid"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zarinpal_summary_item">
                        ...
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_gateways["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="zarinpal_summary_item">
                        <div class="zarinpal_summary_title"><?php echo $chart_info_gateways["midt_label"] ?></div>
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_gateways["midt"], 'fa' ) ?></div>
                    </div>
            ...
            <div>
				...
				$transaction_totals = GFPersian_DB_ZarinPal::get_transaction_totals_this_gateway();
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                <div class="zarinpal_summary_container">
                    <div class="zarinpal_summary_item">
                        <div
                                class="zarinpal_summary_title"><?php _e( "جمع پرداخت های  همه فرمهای زرین پال", "gravityformszarinpal" ) ?></div>
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zarinpal_summary_item">
                        ...
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_hannan["revenue"], 'fa' ) ?></div>
                    </div>

                    <div class="zarinpal_summary_item">
                        <div class="zarinpal_summary_title"><?php echo $chart_info_hannan["mid_label"] ?></div>
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_hannan["mid"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zarinpal_summary_item">
                        ...
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_hannan["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="zarinpal_summary_item">
                        <div class="zarinpal_summary_title"><?php echo $chart_info_hannan["midt_label"] ?></div>
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_hannan["midt"], 'fa' ) ?></div>
                    </div>
                </div>
            </div>
            <hr>
            <div class="clear"></div>
            <h2><?php _e( " کل درآمد های سایت ( همه روشها برای همه فرم ها)", "gravityformszarinpal" ) ?></h2>
            <div>
				...
				$transaction_totals = GFPersian_DB_ZarinPal::get_transaction_totals_site();
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                <div class="zarinpal_summary_container">
                    <div class="zarinpal_summary_item">
                        <div
                                class="zarinpal_summary_title"><?php _e( "جمع کل پرداخت های همه فرمهای سایت", "gravityformszarinpal" ) ?></div>
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zarinpal_summary_item">
                        ...
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_site["revenue"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zarinpal_summary_item">
                        ...
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_site["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="zarinpal_summary_item">
                        <div class="zarinpal_summary_title"><?php echo $chart_info_site["midt_label"] ?></div>
                        <div
                                class="zarinpal_summary_value"><?php echo GF_tr_num( $chart_info_site["midt"], 'fa' ) ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            jQuery("#graph_placeholder").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zarinpal_graph_tooltips);
            });
			<?php endif;?>
            ...
            jQuery("#graph_placeholder1").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zarinpal_graph_tooltip1s1);
            });
			<?php endif;?>
            ...
            jQuery("#graph_placeholder2").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zarinpal_graph_tooltip2s2);
            });
			<?php endif;?>
            ...
            jQuery("#graph_placeholder3").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zarinpal_graph_tooltip3s3);
            });
			<?php endif;?>
	...
	public static function lastxdays_chart_info( $form_id, $chart, $x ) {
		...
		if ( $chart == 1 ) {
			...
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_ZarinPal::get_entry_table_name() . " l
