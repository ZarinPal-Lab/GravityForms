...
class GFPersian_Chart_ZarinGate {

	// ------------------------GravityForms.IR-------------------------
	public static function stats_page() {

		if ( ! empty( $_POST ) ) {
			check_admin_referer( "search", "gf_zaringate_chart" );
		}
        ...
        <style type="text/css">
            ...
            .zaringate_summary_value {
                font-size: 20px;
                margin: 5px 0;
            }

            .zaringate_summary_title {
                height: 40px;
            }
        ...
        <div class="wrap">
            <ul class="subsubsub">
                <li><a class="<?php echo ( ! rgget( "tab" ) || rgget( "tab" ) == "today" ) ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>"><?php _e( "امروز", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "yesterday" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=yesterday"><?php _e( "دیروز", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last7days" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last7days"><?php _e( "هفت روز گذشته", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thisweek" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thisweek"><?php _e( "هفته جاری", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last30days" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last30days"><?php _e( "30 روز گذشته", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thismonth" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thismonth"><?php _e( "ماه جاری", "gravityformszaringate" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "lastmonth" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=lastmonth"><?php _e( "ماه قبل", "gravityformszaringate" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last2month" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last2month"><?php _e( "2 ماه اخیر", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last3month" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last3month"><?php _e( "3 ماه اخیر", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last6month" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last6month"><?php _e( "6 ماه اخیر", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last9month" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last9month"><?php _e( "9 ماه اخیر", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last12month" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last12month"><?php _e( "یک سال اخیر", "gravityformszaringate" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "spring" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=spring"><?php _e( "بهار", "gravityformszaringate" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "summer" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=summer"><?php _e( "تابستان", "gravityformszaringate" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "fall" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=fall"><?php _e( "پاییز", "gravityformszaringate" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "winter" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=winter"><?php _e( "زمستان", "gravityformszaringate" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thisyear" ? "current" : "" ?>"
                       href="?page=gf_zaringate&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thisyear"><?php _e( "امسال", "gravityformszaringate" ); ?></a>
                </li>
                <br/><br/>
                <form method="post"
                      action="?page=gf_zaringate&view=stats&id=<?php echo rgget( "id" ) ?>&tab=selection"><?php wp_nonce_field( "search", "gf_zaringate_chart" ) ?>
                    ...
                    <input type="submit" class="button-primary button" name="submit"
                           value="<?php _e( 'انتخاب', 'gravityformszaringate' ) ?>"><br>
                </form>
            </ul>
            ...
            <div>
				<?php if ( empty( $chart_info["series"] ) ) { ?>
                    <div
                            class="zaringate_message_container"><?php _e( "موردی یافت نشد . ", "gravityformszaringate" ) ?></div>
				<?php } else { ?>
				...
				$transaction_totals = GFPersian_DB_ZarinGate::get_transaction_totals( $form_id );
                ...
                <div class="zaringate_summary_container">
                    <div class="zaringate_summary_item">
                        <div
                                class="zaringate_summary_title"><?php _e( 'جمع پرداخت های  زرین گیت این فرم', 'gravityformszaringate' ) ?></div>
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
            ...
            <hr>
            <div class="clear"></div>
            <h2><?php _e( " درآمد از همه روشها برای فرمِ ", "gravityformszaringate" ) ?><?php echo '"' . $form["title"] . '"'; ?></h2>
            <div>
				...
				$sales_label = __( "تعداد کل پرداخت های  همه روشهای این فرم", "gravityformszaringate" );

				$transaction_totals = GFPersian_DB_ZarinGate::get_transaction_totals_gateways( $form_id );
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                ...
                <div class="zaringate_summary_container">
                    ...
                    <div class="zaringate_summary_item">
                        <div
                                class="zaringate_summary_title"><?php _e( "جمع پرداخت های  همه روشهای این فرم", "gravityformszaringate" ) ?></div>
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zaringate_summary_item">
                        ...
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_gateways["revenue"], 'fa' ) ?></div>
                    </div>

                    <div class="zaringate_summary_item">
                        <div class="zaringate_summary_title"><?php echo $chart_info_gateways["mid_label"] ?></div>
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_gateways["mid"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zaringate_summary_item">
                        ...
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_gateways["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="zaringate_summary_item">
                        <div class="zaringate_summary_title"><?php echo $chart_info_gateways["midt_label"] ?></div>
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_gateways["midt"], 'fa' ) ?></div>
                    </div>
            ...
            <div>
				...
				$transaction_totals = GFPersian_DB_ZarinGate::get_transaction_totals_this_gateway();
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                <div class="zaringate_summary_container">
                    <div class="zaringate_summary_item">
                        <div
                                class="zaringate_summary_title"><?php _e( "جمع پرداخت های  همه فرمهای زرین گیت", "gravityformszaringate" ) ?></div>
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zaringate_summary_item">
                        ...
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_hannan["revenue"], 'fa' ) ?></div>
                    </div>

                    <div class="zaringate_summary_item">
                        <div class="zaringate_summary_title"><?php echo $chart_info_hannan["mid_label"] ?></div>
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_hannan["mid"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zaringate_summary_item">
                        ...
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_hannan["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="zaringate_summary_item">
                        <div class="zaringate_summary_title"><?php echo $chart_info_hannan["midt_label"] ?></div>
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_hannan["midt"], 'fa' ) ?></div>
                    </div>
                </div>
            </div>
            <hr>
            <div class="clear"></div>
            <h2><?php _e( " کل درآمد های سایت ( همه روشها برای همه فرم ها)", "gravityformszaringate" ) ?></h2>
            <div>
				...
				$transaction_totals = GFPersian_DB_ZarinGate::get_transaction_totals_site();
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                <div class="zaringate_summary_container">
                    <div class="zaringate_summary_item">
                        <div
                                class="zaringate_summary_title"><?php _e( "جمع کل پرداخت های همه فرمهای سایت", "gravityformszaringate" ) ?></div>
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zaringate_summary_item">
                        ...
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_site["revenue"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="zaringate_summary_item">
                        ...
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_site["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="zaringate_summary_item">
                        <div class="zaringate_summary_title"><?php echo $chart_info_site["midt_label"] ?></div>
                        <div
                                class="zaringate_summary_value"><?php echo GF_tr_num( $chart_info_site["midt"], 'fa' ) ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            jQuery("#graph_placeholder").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zaringate_graph_tooltips);
            });
			<?php endif;?>
            ...
            jQuery("#graph_placeholder1").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zaringate_graph_tooltip1s1);
            });
			<?php endif;?>
            ...
            jQuery("#graph_placeholder2").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zaringate_graph_tooltip2s2);
            });
			<?php endif;?>
            ...
            jQuery("#graph_placeholder3").bind("plothover", function (event, pos, item) {
                startShowTooltip(item, zaringate_graph_tooltip3s3);
            });
			<?php endif;?>
	...
	public static function lastxdays_chart_info( $form_id, $chart, $x ) {
		...
		if ( $chart == 1 ) {
			...
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_ZarinGate::get_entry_table_name() . " l
