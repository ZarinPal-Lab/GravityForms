...
class GFZarinPal {
    ...
    public static function init(){
        ...
        if(is_admin()){
            ...
            add_action('gform_payment_status', array('GFZarinPal','admin_edit_payment_status_by_HANNANStd'), 3, 3);
			...
			add_action('gform_entry_info', array('GFZarinPal','gateway_entry_info_By_HANNANStd'), 10, 2);
            if(self::is_zarinpal_page()){
                require_once(GFCommon::get_base_path() . "/tooltips.php");
                add_filter('gform_tooltips', array('GFZarinPal', 'tooltips'));
                ...
                add_action('wp_ajax_gf_zarinpal_load_notifications', array('GFZarinPal', 'load_notifications_By_HANNANStd'));
            }
    ...
    public static function tooltips($tooltips){
        $zarinpal_tooltips = array();
        return array_merge($tooltips, $zarinpal_tooltips);
    }
	...
	<div class="wrap">
		...
		<ul class="subsubsub">
                    <li><a class="<?php echo (!RGForms::get("tab") || RGForms::get("tab") == "today") ? "current" : "" ?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>"><?php _e("امروز", "gravityforms"); ?></a> | </li>
					<li><a class="<?php echo RGForms::get("tab") == "yesterday" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=yesterday"><?php _e("دیروز", "gravityforms"); ?></a> | </li>
                    <li><a class="<?php echo RGForms::get("tab") == "last7days" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=last7days"><?php _e("هفت روز گذشته", "gravityforms"); ?></a> | </li>
                    <li><a class="<?php echo RGForms::get("tab") == "thisweek" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=thisweek"><?php _e("هفته جاری", "gravityforms"); ?></a> | </li>
                    <li><a class="<?php echo RGForms::get("tab") == "last30days" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=last30days"><?php _e("30 روز گذشته", "gravityforms"); ?></a> | </li>
                    <li><a class="<?php echo RGForms::get("tab") == "thismonth" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=thismonth"><?php _e("ماه جاری", "gravityforms"); ?></a>|</li>
					<li><a class="<?php echo RGForms::get("tab") == "lastmonth" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=lastmonth"><?php _e("ماه قبل", "gravityforms"); ?></a>|</li>
					<li><a class="<?php echo RGForms::get("tab") == "last2month" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=last2month"><?php _e("2 ماه اخیر", "gravityforms"); ?></a> | </li>
					<li><a class="<?php echo RGForms::get("tab") == "last3month" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=last3month"><?php _e("3 ماه اخیر", "gravityforms"); ?></a> | </li>
                    <li><a class="<?php echo RGForms::get("tab") == "last6month" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=last6month"><?php _e("6 ماه اخیر", "gravityforms"); ?></a> | </li>
                    <li><a class="<?php echo RGForms::get("tab") == "last9month" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=last9month"><?php _e("9 ماه اخیر", "gravityforms"); ?></a> | </li>
                    <li><a class="<?php echo RGForms::get("tab") == "last12month" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=last12month"><?php _e("یک سال اخیر", "gravityforms"); ?></a> | </li>
					<li><a class="<?php echo RGForms::get("tab") == "spring" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=spring"><?php _e("بهار", "gravityforms"); ?></a>|</li>
					<li><a class="<?php echo RGForms::get("tab") == "summer" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=summer"><?php _e("تابستان", "gravityforms"); ?></a>|</li>
					<li><a class="<?php echo RGForms::get("tab") == "fall" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=fall"><?php _e("پاییز", "gravityforms"); ?></a>|</li>
					<li><a class="<?php echo RGForms::get("tab") == "winter" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=winter"><?php _e("زمستان", "gravityforms"); ?></a>|</li>
					<li><a class="<?php echo RGForms::get("tab") == "thisyear" ? "current" : ""?>" href="?page=gf_zarinpal&view=stats&id=<?php echo $_GET["id"] ?>&tab=thisyear"><?php _e("امسال", "gravityforms"); ?></a></li>      
					<br/><br/>
	...
	private static function edit_page(){
        ...
        <style>
			...
			#zarinpal_customer_field_tozihat {width:198px !important;}
...
<div class="inside">
        ...
        <script type="text/javascript">
            jQuery(document).ready(function(){
                SetPeriodNumber('#gf_zarinpal_billing_cycle_number', jQuery("#gf_zarinpal_billing_cycle_type").val());
                SetPeriodNumber('#gf_zarinpal_trial_period_number', jQuery("#gf_zarinpal_trial_period_type").val());
            });
            function SelectType(type){
                jQuery("#zarinpal_field_group").slideUp();
                jQuery("#zarinpal_field_group input[type=\"text\"], #zarinpal_field_group select").val("");
                jQuery("#gf_zarinpal_trial_period_type, #gf_zarinpal_billing_cycle_type").val("M");
            ...
            function EndSelectForm(form_meta, customer_fields, recurring_amount_options){
                ...
                if( (type == "product" || type =="subscription") && GetFieldsByType(["product"]).length == 0){
                    ...
                    jQuery("#gf_zarinpal_invalid_donation_form").show();
                    jQuery("#zarinpal_wait").hide();
                    return;
                }
                ...
                jQuery("#gf_zarinpal_recurring_amount").html(recurring_amount_options);
        ...
        <script type="text/javascript">
            ...
            function GetFieldValues(fieldId, selectedValue, labelMaxCharacters){
				...
				else
				{
					...
					str += "<input type='text' placeholder='<?php _e("یک مقدار وارد نمایید", "gravityforms"); ?>' id='gf_zarinpal_conditional_value' name='gf_zarinpal_conditional_value' value='" + selectedValue.replace(/'/g, "&#039;") + "'>";
				}
                return str;
            }
...
<?php
 ...
 return $message;
	...
	$wp_session = WP_Session::get_instance();
	if (isset($entry['transaction_id']) && !isset($wp_session['refid_zarinpal']) ) { 
	unset($vaziat);
...
return $total;
	...
	public static function uninstall(){
        ...
        delete_option("gf_zarinpal_site_name");
        delete_option("gf_zarinpal_auth_token");
   ...
   private static function get_customer_information($form, $config=null){
    ...
    {	
    	...
    	if ($payment_gateway <> "zarinpal" || strtolower(rgpost("save")) <> __("Edit", "gravityforms"))
    	return $payment_status;	
		$payment_string = gform_tooltip("zarinpal_edit_payment_status","",true);
    ...
    {	$form_action = strtolower(rgpost("save"));
		$payment_gateway = rgar($lead, "payment_method");
		if ($payment_gateway <> "zarinpal" || $form_action <> __("Edit", "gravityforms"))
			return;
...
echo 'درگاه پرداخت : زرین پال (غیر قابل ویرایش)<br><br>پرداخت هزینه اشتراک';
}
if($lead["payment_status"] == 'Paid') {
echo 'درگاه پرداخت : زرین پال (غیر قابل ویرایش)<br><br>پرداخت معمولی';
}
}
}	
