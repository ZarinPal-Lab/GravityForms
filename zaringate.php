...
class GFZarinGate_HANNANStd
{
    ...
    public static function admin_notice_persian_gf()
    {
        ...
        $message = sprintf(__("برای استفاده از درگاه های پرداخت گرویتی فرم نصب بسته فارسی ساز الزامی است . برای نصب فارسی ساز %sکلیک کنید%s.", "gravityformszaringate"), '<a href="' . admin_url("plugin-install.php?tab=plugin-information&plugin=persian-gravity-forms&TB_iframe=true&width=772&height=884") . '">', '</a>');
    ...
    public static function settings_page()
    {
        ...
        <form action="" method="post">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row"><label
                            for="gf_zaringate_configured"><?php _e("فعالسازی", "gravityformszaringate"); ?></label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label
                            for="gf_zaringate_server"><?php _e("کشور سرور", "gravityformszaringate"); ?></label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label
                            for="gf_zaringate_merchent"><?php _e("مرچنت", "gravityformszaringate"); ?></label></th>
                    <td>
                                    ...
                                    <table class="form-table gforms_form_settings"
                                        ...
                                        <tr <?php echo $display_post_fields ? "" : "style='display:none;'" ?>>
                                            ...
                                            <td>
                                                <select id="gf_zaringate_update_action1"
                                                    ...
                                                    <option
                                                        value="publish" <?php echo rgar($config["meta"], "update_post_action1") == "publish" ? "selected='selected'" : "" ?>><?php _e("منشتر شده", "gravityformszaringate") ?></option>
                                                    <option
                                        ...
                                        <tr <?php echo $display_post_fields ? "" : "style='display:none;'" ?>>
                                            ...
                                            <td>
                                                <select id="gf_zaringate_update_action2"
                                                    ...
                                                    <option
                                                        value="publish" <?php echo rgar($config["meta"], "update_post_action2") == "publish" ? "selected='selected'" : "" ?>><?php _e("منشتر شده", "gravityformszaringate") ?></option>
                                                    <option
                                            ...
                                            <td>
                                                ...
                                                foreach ($confirmations as $confirmation) { ?>
                                                    <li class="gf_zaringate_confirmation">
                                                        <input
                                                            id="gf_zaringate_conf_1_<?php echo $confirmation['id'] ?>"
                                                            name="gf_zaringate_conf_1[]" type="checkbox"
                                                        ...
                                                        <label
                                                            for="gf_zaringate_conf_1_<?php echo $confirmation['id'] ?>"
                                                            class="inline"
                                                            for="gf_zaringate_selected_confirmations"><?php echo $confirmation['name']; ?></label>
                                                    </li>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="gf_zaringate_confirmations_2" <?php echo !isset($form["confirmations"]) ? "style='display:none;'" : "" ?>>
                                            ...
                                            <td>
                                                ...
                                                foreach ($confirmations as $confirmation) { ?>
                                                    <li class="gf_zaringate_confirmation">
                                                        <input
                                                            id="gf_zaringate_conf_2_<?php echo $confirmation['id'] ?>"
                                                            name="gf_zaringate_conf_2[]" type="checkbox"
                                                            class="confirmation_checkbox"
                                                            value="<?php echo $confirmation['id'] ?>" <?php checked(true, in_array($confirmation['id'], $selected_confirmations)) ?> />
                                                        <label
                                                            for="gf_zaringate_conf_2_<?php echo $confirmation['id'] ?>"
                                                            class="inline"
                                                            for="gf_zaringate_selected_confirmations"><?php echo $confirmation['name']; ?></label>
                                                    </li>
                                                <?php } ?>
                                        ...
                                        <tr id="gf_zaringate_confirmations_3" <?php echo !isset($form["confirmations"]) ? "style='display:none;'" : "" ?>>
                                            ...
                                            <td>
                                                ...
                                                foreach ($confirmations as $confirmation) { ?>
                                                    <li class="gf_zaringate_confirmation">
                                                        <input
                                                            id="gf_zaringate_conf_3_<?php echo $confirmation['id'] ?>"
                                                            name="gf_zaringate_conf_3[]" type="checkbox"
                                                            class="confirmation_checkbox"
                                                            value="<?php echo $confirmation['id'] ?>" <?php checked(true, in_array($confirmation['id'], $selected_confirmations)) ?> />
                                                        <label
                                                            for="gf_zaringate_conf_3_<?php echo $confirmation['id'] ?>"
                                                            class="inline"
                                                            for="gf_zaringate_selected_confirmations"><?php echo $confirmation['name']; ?></label>
                                                    </li>
                                                <?php } ?>
                                            ...
                                            <td>
                                                ...
                                                foreach ($notifications as $notification) { ?>
                                                    <li class="gf_zaringate_notification">
                                                        <input
                                                            id="gf_zaringate_notif_1_<?php echo $notification['id'] ?>"
                                                            name="gf_zaringate_notif_1[]" type="checkbox"
                                                        ...
                                                        <label
                                                            for="gf_zaringate_notif_1_<?php echo $notification['id'] ?>"
                                                            class="inline"
                                                            for="gf_zaringate_selected_notifications"><?php echo $notification['name']; ?></label>
                                                    </li>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="gf_zaringate_notifications" <?php echo !isset($form["notifications"]) ? "style='display:none;'" : "" ?>>
                                            ...
                                            <td>
                                                ...
                                                foreach ($notifications as $notification) { ?>
                                                    <li class="gf_zaringate_notification">
                                                        <input
                                                            id="gf_zaringate_notif_2_<?php echo $notification['id'] ?>"
                                                            name="gf_zaringate_notif_2[]" type="checkbox"
                                                            class="notification_checkbox"
                                                            value="<?php echo $notification['id'] ?>" <?php checked(true, in_array($notification['id'], $selected_notifications)) ?> />
                                                        <label
                                                            for="gf_zaringate_notif_2_<?php echo $notification['id'] ?>"
                                                            class="inline"
                                                            for="gf_zaringate_selected_notifications"><?php echo $notification['name']; ?></label>
                                                    </li>
                                                <?php } ?>
                                        ...
                                        <tr id="gf_zaringate_notifications" <?php echo !isset($form["notifications"]) ? "style='display:none;'" : "" ?>>
                                            ...
                                            <td>
                                                ...
                                                foreach ($notifications as $notification) { ?>
                                                    <li class="gf_zaringate_notification">
                                                        <input
                                                            id="gf_zaringate_notif_3_<?php echo $notification['id'] ?>"
                                                            name="gf_zaringate_notif_3[]" type="checkbox"
                                                            class="notification_checkbox"
                                                            value="<?php echo $notification['id'] ?>" <?php checked(true, in_array($notification['id'], $selected_notifications)) ?> />
                                                        <label
                                                            for="gf_zaringate_notif_3_<?php echo $notification['id'] ?>"
                                                            class="inline"
                                                            for="gf_zaringate_selected_notifications"><?php echo $notification['name']; ?></label>
                                                    </li>
                                                <?php } ?>
                                        ...
                                        <tr id="gf_zaringate_notifications" <?php echo !isset($form["notifications"]) ? "style='display:none;'" : "" ?>>
                                            ...
                                            <td>
                                                ...
                                                foreach ($notifications as $notification) { ?>
                                                    <li class="gf_zaringate_notification">
                                                        <input
                                                            id="gf_zaringate_notif_4_<?php echo $notification['id'] ?>"
                                                            name="gf_zaringate_notif_4[]" type="checkbox"
                                                            class="notification_checkbox"
                                                            value="<?php echo $notification['id'] ?>" <?php checked(true, in_array($notification['id'], $selected_notifications)) ?> />
                                                        <label
                                                            for="gf_zaringate_notif_4_<?php echo $notification['id'] ?>"
                                                            class="inline"
                                                            for="gf_zaringate_selected_notifications"><?php echo $notification['name']; ?></label>
                                                    </li>
                                                <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="description"><?php _e('گرویتی فرم دارای ادان های مختلف وابسته به GFAddon نظیر ایمیل مارکتینگ و ... می باشد که دارای متد add_delayed_payment_support هستند. در صورتی که میخواهید این ادان ها تنها در صورت تراکنش موفق عمل کنند این گزینه را تیک بزنید.', 'gravityformszaringate'); ?></span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="radio" name="gf_zaringate_shaparak"
                                                       id="gf_zaringate_shaparak_raygan"
                                                       value="raygan" <?php echo rgar($config['meta'], 'shaparak') != "sadt" ? "checked" : "" ?>/>
                                                <label class="inline"
                                                       for="gf_zaringate_shaparak_raygan"><?php _e("رایگان شود", "gravityformszaringate"); ?></label>

                                                <input type="radio" name="gf_zaringate_shaparak"
                                                       id="gf_zaringate_shaparak_sadt"
                                                       value="sadt" <?php echo rgar($config['meta'], 'shaparak') == "sadt" ? "checked" : "" ?>/>
                                                <label class="inline"
                                                       for="gf_zaringate_shaparak_sadt"><?php echo $minprice . __(" شود ", "gravityformszaringate"); ?></label>
                                                <span
                                                    class="description"><?php _e('(قابل استفاده برای زمانیکه منطق شرطی درگاه فعال نباشد)', 'gravityformszaringate'); ?></span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label
                                                    for="gf_zaringate_conditional_enable"><?php _e("فعالسازی این درگاه اگر شرط زیر برقرار باشد", "gravityformszaringate"); ?></label><br/>

                                                <table cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td>
                                                            <div
                                                                id="gf_zaringate_conditional_container" <?php echo !rgar($config['meta'], 'zaringate_conditional_enabled') ? "style='display:none'" : "" ?>>
                                                                <div id="gf_zaringate_conditional_fields"
                                                                     style="display:none">
                                                                    <select id="gf_zaringate_conditional_field_id"
                                                                            name="gf_zaringate_conditional_field_id"
                                                                            class="optin_select"
                                                                            onchange='jQuery("#gf_zaringate_conditional_value_container").html(GetFieldValues(jQuery(this).val(), "", 20));'></select>
                                                                    <select id="gf_zaringate_conditional_operator"
                                                                            name="gf_zaringate_conditional_operator">
                                                                        <option
                                                                            value="is" <?php echo rgar($config['meta'], 'zaringate_conditional_operator') == "is" ? "selected='selected'" : "" ?>><?php _e("هست", "gravityformszaringate") ?></option>
                                                                        <option
                                                                            value="isnot" <?php echo rgar($config['meta'], 'zaringate_conditional_operator') == "isnot" ? "selected='selected'" : "" ?>><?php _e("نیست", "gravityformszaringate") ?></option>
                                                                        <option
                                                                            value=">" <?php echo rgar($config['meta'], 'zaringate_conditional_operator') == ">" ? "selected='selected'" : "" ?>><?php _e("بزرگ تر است از", "gravityformszaringate") ?></option>
                                                                        <option
                                                                            value="<" <?php echo rgar($config['meta'], 'zaringate_conditional_operator') == "<" ? "selected='selected'" : "" ?>><?php _e("کوچک تر است از", "gravityformszaringate") ?></option>
                                                                        <option
                                                                            value="contains" <?php echo rgar($config['meta'], 'zaringate_conditional_operator') == "contains" ? "selected='selected'" : "" ?>><?php _e("شامل میشود ", "gravityformszaringate") ?></option>
                                                                        <option
                                                                            value="starts_with" <?php echo rgar($config['meta'], 'zaringate_conditional_operator') == "starts_with" ? "selected='selected'" : "" ?>><?php _e("شروع میشود با", "gravityformszaringate") ?></option>
                                                                        <option
                                                                            value="ends_with" <?php echo rgar($config['meta'], 'zaringate_conditional_operator') == "ends_with" ? "selected='selected'" : "" ?>><?php _e("تمام میشود با", "gravityformszaringate") ?></option>
                                                                    </select>
                                                                    <div id="gf_zaringate_conditional_value_container"
                                                                         name="gf_zaringate_conditional_value_container"
                                                                         style="display:inline;"></div>
                                                                </div>
                                                                <div id="gf_zaringate_conditional_message"
    ...
    public static function Request($confirmation, $form, $entry, $ajax)
    {
        ...
        if (!$valid_checker) {
            ...
            $Description = __('جهت بررسی تنظیمات صحیح بودن تنظیمات درگاه گرویتی فرم زرین گیت', 'gravityformszaringate');
